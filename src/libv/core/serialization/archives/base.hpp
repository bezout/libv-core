...
, T &value
, typename boost::enable_if_c<SerializableTraits<T>::rank>::type * = 0
)
{
...
, const size_t *extents ///< The extents of \e values.
, size_t rank ///< The rank of \e values.
, typename boost::enable_if_c<!(SerializableTraits<T>::rank && SerializableTraits<T>::size) && !boost::is_fundamental<T>::value>::type * = 0
)
{
