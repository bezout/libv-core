...
\
  /** \copydoc load_eigen() */\
  template<class T, int n1, int n2, int n3, int n4, int n5>\
  void load(/** An archive. */ InputArchive &archive, /** A list of matrices. */ _type<T, n1, n2, n3, n4, n5> *values, /** A list of extents. */ const size_t *extents, /** The rank of the array. */ size_t rank, typename boost::enable_if_c<n1 != Eigen::Dynamic && n2 != Eigen::Dynamic>::type * = 0)\
  {\
...
\
  /** \copydoc save_eigen() */\
  template<class T, int n1, int n2, int n3, int n4, int n5>\
  void save(/** An archive. */ OutputArchive &archive, /** A list of matrices. */ const _type<T, n1, n2, n3, n4, n5> *values, /** A list of extents. */ size_t *extents, /** The rank of the array. */ size_t rank, typename boost::enable_if_c<n1 != Eigen::Dynamic && n2 != Eigen::Dynamic>::type * = 0)\
  {\
