...
#define V_ENABLE_IF(_test, _type)(typename boost::conditional<(_test), _type, struct V_CONCATENATE(DISABLED_AT_LINE_, __LINE__) &>::type
...
#define V_ENABLE_IF_TPL(_test), typename boost::enable_if_c<(_test)>::type * = 0)
